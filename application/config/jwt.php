...
$config['key'] = "apicodeigniter"; // secret key
$config['iss'] = "http://localhost:8080/apicodeigniter/"; // domain name
$config['aud'] = "http://localhost:8080/apicodeigniter/"; // domain name
